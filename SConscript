...
env.Program('test/debug.cpp', LIBS=[dc_lib, ryu_lib, dragonbox_lib])
env.Program('test/run.cpp', LIBS=[dc_lib, ryu_lib, dragonbox_lib])
env.Program('test/speed.cpp', LIBS=[dc_lib, ryu_lib, dragonbox_lib])
